      ...
      <table border='1'>
       ...
       {admin.map((f)=> (
              <tr key={f.EDU_CODE}>
                ...
                <td>{f.PUBLICITY==="YES"? <input type='button' name={f.EDU_CODE} value="승인취소" onClick={noApprove} className="listbuttonred"></input>:<input type='button' name={f.EDU_CODE} value="승인하기" onClick={approve} className="listbuttonblue"></input>}</td>
